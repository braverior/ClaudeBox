        ...
        <div className="px-6 py-4 border-t border-border flex gap-2 flex-shrink-0">
          {projects.length > 0 && (
            <button
              ...
              className={`flex-1 py-2 rounded-lg border transition-colors text-sm font-medium flex items-center justify-center gap-2 ${
                confirmingAll
          ...
          <button
            onClick={onClose}
            className="flex-1 py-2 rounded-lg bg-accent text-white hover:bg-accent-hover transition-colors text-sm font-medium"
          >
            {t("settings.done")}
          </button>
        </div>
