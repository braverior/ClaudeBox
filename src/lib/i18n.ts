...
const en: TranslationDict = {
  ...
  "session.deleteConfirm": "Delete this session? This permanently removes Claude's transcript file — the CLI history is also gone and cannot be recovered.",
...
const zh: TranslationDict = {
  ...
  "session.delete": "删除会话",
  "session.deleteConfirm": "删除该会话？这会永久删除 Claude 的对话记录文件——CLI 中的历史也将一并消失且无法恢复。",
  "session.switch": "切换会话",
  "session.list": "会话列表",
